__kernel void fhtsw( __global float* data,
...
__kernel void fhtsh( __global float* data,
...
__kernel void fhts( __global float* data,
...
__kernel void fhtf( __global float* data,
    int w,
    int h,
    int d,
    int numSM, // number of SMs available on this device
